    ...
    <div class="container1">
        <div class="login">
            <div class="container2">
                <img src="edit-diary-title-low-resolution-logo-white-on-transparent-background.png"></div>

                <div class="login-form">
                    <form action="edit_diary_backend.php?diary_id=<?php echo $diary_id?>" method="POST">
                    ...
                    <input name="diary_id" type="hidden" value="<?php echo $_GET['diary_id']?>">
                        ...
                        <div class="diary_input">
                            <i class='fas'>&#xf518;</i><input name="diary_title" id="diary_title" placeholder="Diary Title" type="text" value="<?php echo $diaryDetails['diary_title']?>" required>
                        </div>
                        
                        <button class="create_btn">Edit</button>
                    </form>
                </div>
            </div>
        </div>
